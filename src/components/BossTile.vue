<template>
	...
	>
		<div class="flex flex-1 flex-col justify-between">
			<p v-if="!loading" class="text-base font-sans select-none md:text-lg text-white">
				{{ boss?.jp_name ?? $t("label.unknown") }}
			</p>
			<p v-if="!loading" class="text-base font-sans select-none md:text-lg text-white mt-1">
